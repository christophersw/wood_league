"""
Title: test_dashboard_view.py — Tests for the HTMX dashboard partials
Description:
    Verifies the seven HTMX-polled dashboard partials each return 200 to
    admin users, and that the partial views return the expected data shapes.
    The legacy dashboard shell and diagnostics redirect tests have been
    removed (#200) — the combined overview page is tested in
    test_views_schedule.py.

Changelog:
    2026-05-22 (#200): Remove shell/diagnostics tests; add dash_logs to
        parametrize; update docstring.
